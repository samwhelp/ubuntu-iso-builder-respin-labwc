...
# ubuntu-iso-builder-respin-labwc
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-labwc](https://samwhelp.github.io/ubuntu-iso-builder-remix-labwc/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-labwc) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-labwc](https://samwhelp.github.io/ubuntu-iso-builder-respin-labwc/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-labwc) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-labwc/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-labwc/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-labwc/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-labwc](https://github.com/samwhelp/ubuntu-iso-builder-respin-labwc)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-labwc.git
```


> change dir to `ubuntu-iso-builder-respin-labwc`

``` sh
cd ubuntu-iso-builder-respin-labwc
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-labwc/dist`
...
| [Labwc / Note](https://samwhelp.github.io/note-about-labwc/) | [GitHub](https://github.com/samwhelp/note-about-labwc) |
